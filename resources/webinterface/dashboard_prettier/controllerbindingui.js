 ...
 */ !(function (e) {
  ...
  "/i/y": function (e, t, n) {
          ...
          switch (t.nodeName.toUpperCase()) {
            case "VSG-TRANSFORM":
              (i = B("transform", t)),
                ...
                (i.properties["curvature-pitch"] = k(t, "curvature-pitch")),
            ...
            case "VSG-ELASTIC-HEAD-TRANSFORM":
              (i = B("elasticheadtransform", t)),
                (i.properties["start-angle-threshold"] = k(
                  t,
                  "start-angle-threshold"
                )),
                (i.properties["stop-angle-threshold"] = k(
                  t,
                  "stop-angle-threshold"
                )),
                (i.properties["ease-in-time"] = k(t, "ease-in-time")),
                (i.properties["ease-in-power"] = k(t, "ease-in-power")),
                (i.properties["ease-out-angle-threshold"] = k(
                  t,
                  "ease-out-angle-threshold"
                )),
                (i.properties["ease-out-power"] = k(t, "ease-out-power")),
                (i.properties["min-angular-velocity"] = k(
                  t,
                  "min-angular-velocity"
                )),
                (i.properties["max-angular-velocity"] = k(
                  t,
            ...
            case "VSG-LINE":
              (i = B("line", t)),
                ...
                (i.properties.thickness = k(t, "thickness")),
                (i.properties["start-buffer"] = k(t, "start-buffer")),
                (i.properties["end-buffer"] = k(t, "end-buffer"));
              break;
            case "VSG-LINE-CONSTRAINED-TRANSFORM":
              (i = B("line-constrained-transform", t)),
                (i.properties["target-id"] = T(t, "target-id")),
                (i.properties["source-id"] = T(t, "source-id")),
                (i.properties["source-distance"] = k(t, "source-distance")),
                (i.properties["target-limit"] = k(t, "target-limit"));
              break;
            ...
            case "VSG-PIN-TO-VIEW-TRANSFORM":
              (i = B("pin-to-view-transform", t)),
                (i.properties["offscreen-z-depth"] = k(t, "offscreen-z-depth")),
                (i.properties["off-axis-limit"] = k(t, "off-axis-limit")),
                (i.properties["transition-limit"] = k(t, "transition-limit"));
              break;
            case "VSG-MANIPULATION-TRANSFORM":
              (i = B("manipulation-transform", t)),
                (i.properties["is-moving"] = R(t, "is-moving")),
                (i.properties["parent-path"] = w(t, "parent-path")),
                (i.properties.translation = M(t, "translation")),
                (i.properties.rotation = M(t, "rotation")),
                (i.properties.scale = M(t, "scale"));
      ...
      (n = e),
        (null == (t = H) || null == n
          ...
          : t.color_mult == n.color_mult &&
            t.reflection_mult == n.reflection_mult) || ((H = e), K());
    }
    function K() {
      j ||
        (j = window.setTimeout(
    ...
    class ne extends ee {
      ...
      buildNode(e, t) {
        ...
        return (
          (n.properties.mountable_id = G(this.props.mountedId)),
    ...
    class oe extends ee {
      ...
      buildNode(e, t) {
        ...
        return (
          ...
          (o.properties.mountable_id = G(this.m_sMountableUnqualifiedID)),
    ...
    var ae, se, le, ce, de, pe, he, ue, me, be, ge;
    Object(o.b)([r.a], re.prototype, "buildNode", null),
      (function (e) {
        (e[(e.Seated = 0)] = "Seated"),
      ...
      internalRender() {
        ...
        this.props.transform
          ...
          : ((e = Q(this.props.translation, { x: 0, y: 0, z: 0 })),
            (t = g(
              u(Q(this.props.rotation, { x: 0, y: 0, z: 0 }), Math.PI / 180)
            )),
            (n =
        ...
        return I.createElement(
          "vsg-transform",
          {
            ...
            "parent-origin": ae[this.props.parent_origin],
    ...
    class fe extends ee {
      ...
      componentDidMount() {
        super.componentDidMount(),
          ...
          (this.m_nEmbeddedIndex = Ce.Current().addEmbeddedPanelUVs(this)),
          (fe.s_bPanelsAreDirty = !0),
      ...
      componentWillUnmount() {
        this.m_resizeObserver &&
          ...
          (fe.s_bPanelsAreDirty = !0),
          Ce.Current().removeEmbeddedPanelUVs(this),
      ...
      buildNode(e, t) {
        ...
        return (
          ...
          (l.properties.uv_min = null != (n = Se(this.m_UVsMin)) ? n : void 0),
          (l.properties.uv_max = null != (o = Se(this.m_UVsMax)) ? o : void 0),
          (l.properties.width = null != (i = this.props.width) ? i : void 0),
          (l.properties.height = null != (r = this.props.height) ? r : void 0),
          (l.properties["min-width"] =
            null != (a = this.props.min_width) ? a : void 0),
          (l.properties["target-width-anchor-id"] = G(
            this.props.target_width_anchor_id
          )),
          (l.properties["target-dpi-panel-id"] = G(
            this.props.target_dpi_panel_id
          )),
          (l.properties["target-dpi-multiplier"] =
            this.props.target_dpi_multiplier),
          (l.properties.curvature = this.props.curvature),
          (l.properties["curvature-origin-id"] = G(
          ...
          (l.properties["texture-id"] = G(this.props.texture_id)),
    ...
    (fe.s_bPanelsAreDirty = !1),
      Object(o.b)([r.a], fe.prototype, "onResizeObserved", null),
      Object(o.b)([r.a], fe.prototype, "onPanelMouseDown", null),
      Object(o.b)([r.a], fe.prototype, "onWindowMouseUp", null),
      Object(o.b)([r.a], fe.prototype, "buildNode", null);
    ...
    (Ce.s_Current = null),
      (Ce.k_EmbeddedDataRows = 1),
      Object(o.b)([i.bind], Ce.prototype, "toggleDebugPointer", null),
      Object(o.b)([i.bind], Ce.prototype, "onMouseMove", null),
      Object(o.b)([i.bind], Ce.prototype, "forceLayoutUpdate", null),
      Object(o.b)([i.bind], Ce.prototype, "onMutation", null);
    Object(o.b)(
      [r.a],
      class extends ee {
        constructor(e) {
    ...
    class Oe extends ee {
      ...
      buildNode(e, t) {
        ...
        if (
          ((n.properties.source = this.props.source),
          (n.properties["texture-id"] = G(this.props["texture-id"])),
          this.props.fresnel)
        ) {
    ...
    class ke extends ee {
      ...
      buildNode(e, t) {
        ...
        "object" == typeof this.props.location
          ? (n = X(this.props.location, { x: 0, y: 0 }))
    ...
    Object(o.b)([r.a], ke.prototype, "buildNode", null);
    !(function (e) {
    ...
    var Te, Be, Ae, Ne, Pe, Le, xe, Ve, je, Fe, He, Ue, Ge, We, ze, qe, Ke, Xe;
    !(function (e) {
      (e[(e.None = 0)] = "None"),
        (e[(e.Shown = 1)] = "Shown"),
        (e[(e.Hidden = 2)] = "Hidden"),
    ...
    Object(o.b)([r.a], Je.prototype, "buildNode", null);
    class Ze extends ee {
      constructor(e) {
        super(e);
      }
      internalRender() {
        let e = Z(this.props.xfCurrent.translation),
          ...
          n = Z(this.props.xfCurrent.scale);
        return I.createElement(
    ...
    let u = (o = class extends r.Component {
      ...
      OnBeginResetUniverseOriginCountdown(e) {
        ...
        clearTimeout(this.m_countdownTimeout),
          ...
          (this.m_fadeFinishTimeout = 0);
        const o =
          null === (t = s.pb) || void 0 === t
            ? void 0
            : t.VRApplications.GetSceneApplicationKey();
        let i = !o || "system.generated.xrservice" == o;
        i
  ...
  Gmup: function (e, t, n) {
    ...
    var o,
      ...
      g = n("2vnA"),
      _ = n("p9CI");
    let v = (o = class extends c.Component {
      constructor(e) {
        super(e),
    ...
    (v.k_sMailboxName = "systemui_desktoptray"),
      (v = o = Object(r.b)([m.a], v));
    let S = (i = class extends c.Component {
      constructor(e) {
        super(e),
          (this.m_mailbox = new a.c()),
          (this.state = {
      ...
      get currentDesktopIndex() {
        ...
        return "" != this.state.sCurrentWindowOverlayKey
          ? -1
          : null != (e = u.d.settings.get("/settings/dashboard/desktopIndex"))
          ? e
          : 1;
      }
      ...
      updateDesktopIndices() {
        ...
        for (
          ...
          o.push(n), n++;
        (null != (t = u.d.settings.get("/settings/dashboard/desktopIndex"))
          ? t
          : 1) > o.length &&
          u.d.SetSettingsValue("/settings/dashboard/desktopIndex", 1),
      ...
      render() {
        ...
        const t =
          null ==
            (e = u.d.settings.get("/settings/dashboard/allowCurvature")) || e
            ? p.j
            : null;
        return this.props.visible
          ? this.state.bIsUsingSteamDesktop
            ? c.createElement(a.V, {
                mountedId: Object(a.f)(p.F, "valve.steam.desktop"),
              })
            : this.state.bIsReady
              ...
              ? c.createElement(
                  ...
                  c.createElement(
                    a.bb,
                    {
                      ...
                      interactive: !0,
                      origin: a.t.BottomCenter,
                      debug_name: "System Desktop",
                    },
                    c.createElement(a.cb, { id: b.t, location: a.t.TopCenter }),
                    c.createElement(a.V, {
                    ...
                    c.createElement(a.cb, {
                      id: b.s,
                      location: a.t.BottomCenter,
                    })
                  )
                )
              : c.createElement(
    ...
    (S.k_sMailboxName = "systemui_desktopview"),
      ...
      Object(r.b)([g.f], S.prototype, "desktopCount", null),
      Object(r.b)([g.f], S.prototype, "sCurrentOverlayKey", null),
      Object(r.b)([g.f], S.prototype, "currentDesktopIndex", null),
      Object(r.b)([g.f], S.prototype, "currentWindowHwnd", null),
      Object(r.b)([l.a], S.prototype, "onDesktopScaleChange", null),
      Object(r.b)([l.a], S.prototype, "onDesktopChange", null),
      Object(r.b)([l.a], S.prototype, "onDesktopViewUpdating", null),
      Object(r.b)([l.a], S.prototype, "onDesktopViewReady", null),
      Object(r.b)([l.a], S.prototype, "onWindowViewChange", null),
      Object(r.b)([l.a], S.prototype, "ShowDesktop", null),
      (S = i = Object(r.b)([m.a], S));
    var y,
      f = n("hcOo");
    let C = (y = class extends c.Component {
      constructor(e) {
        super(e),
          (this.m_imageSources = []),
          (this.m_imageIndex = -1),
      ...
      render() {
        ...
        return (
          ...
          c.createElement(
            "div",
            {
              className: Object(f.a)("PortraitAppImageContainer", [
                "Fallback",
    ...
    (C.defaultProps = {
      ...
      (C.s_failedImages = []),
      Object(r.b)([s.bind], C.prototype, "loadNextImage", null),
      Object(r.b)([s.bind], C.prototype, "onLoad", null),
      Object(r.b)([s.bind], C.prototype, "onError", null),
      (C = y = Object(r.b)([m.a], C)),
      (function (e) {
    ...
    const E = (e) =>
      c.createElement(
        "div",
        {
          className: Object(f.a)("ButtonContainer", O[e.side], [
            "Disabled",
            !1 === e.enabled,
          ]),
        },
    ...
    Object(r.b)([l.a], I.prototype, "onAnimationFrame", null),
      Object(r.b)([l.a], I.prototype, "onScroll", null),
      Object(r.b)([l.a], I.prototype, "onLeftButtonClick", null),
      Object(r.b)([l.a], I.prototype, "onRightButtonClick", null);
    let M = class extends c.Component {
      constructor(e) {
        super(e),
          (this.m_scrollWatcher = new f.e()),
    ...
    Object(r.b)([l.a], M.prototype, "buttonMouseEnter", null),
      Object(r.b)([l.a], M.prototype, "buttonMouseLeave", null),
      Object(r.b)([l.a], M.prototype, "onParentScrollStop", null),
      (M = Object(r.b)([m.a], M));
    const k = () =>
    ...
    let L = class extends c.Component {
      ...
      render() {
        return this.state.storeData
          ? c.createElement(D, { apps: this.makeAppButtonList() })
          : c.createElement(D, { loading: !0 });
      }
    };
    L = Object(r.b)([m.a], L);
    class x extends c.Component {
      ...
      render() {
        return c.createElement(
          ...
          c.createElement(L, { section: P.Singleplayer }),
          c.createElement(
            "h2",
            null,
            Object(h.c)("#StoreSection_TopMultiplayer")
          ),
          c.createElement(L, { section: P.Multiplayer }),
          c.createElement("h2", null, Object(h.c)("#StoreSection_TopFree")),
          c.createElement(L, { section: P.Free })
        );
      }
    }
    var V;
    ...
    let G = (V = class extends c.Component {
      ...
      launchApplication(e, t, n) {
        ...
        B.a.instance.RecordUIEvent(
          ...
          null === (r = VRHTML) ||
            void 0 === r ||
            r.VRApplications.LaunchApplication(e.key);
      }
      makeAppButtonList() {
        let e = [];
        if (null != u.d.apps)
          for (let t of u.d.apps)
            t.is_internal ||
              ...
              t.is_hidden ||
              t.is_instance ||
              V.s_setBlacklistedAppkeys.has(t.key) ||
              e.push(t);
        e.sort((e, t) => {
        ...
        return e.map((e, n) => {
          let o = n;
          const i = n < V.TOP_ROW_LENGTH;
          return (
            i || (o -= V.TOP_ROW_LENGTH),
            {
              key: e.key,
              appkey: e.key,
              title: e.name,
      ...
      render() {
        ...
        const n =
          ...
          o =
            0 == t.length ||
            u.d.settings.get("/settings/dashboard/hideBigPictureLibrary");
        if (n) e = c.createElement(U, null);
        else {
          let n = t.slice(0, V.TOP_ROW_LENGTH),
            i = t.slice(V.TOP_ROW_LENGTH);
          e = c.createElement(
            c.Fragment,
            null,
            !o && c.createElement(j, null),
            c.createElement("h2", null, Object(h.c)("#RecentlyPlayed")),
            c.createElement(D, { className: "TopRow", apps: n }),
            c.createElement(D, { className: "BottomRow", apps: i })
          );
        }
        return c.createElement(
          b.h,
    ...
    class X extends c.Component {
      ...
      onOpenAppControllerBindingSettings() {
        const e = K.a.Instance.SceneAppKey;
        z.b.OpenDeepLink(z.a.Name, e);
      }
      onOpenAppVideoSettings() {
        const e = K.a.Instance.SceneAppKey;
        W.b.OpenDeepLink(W.c.Name, e);
      }
      render() {
        var e;
        const t = K.a.Instance.SceneAppKey,
          n = K.a.Instance.SceneAppName,
          o = K.a.Instance.SceneApplicationState,
          i = K.a.Instance.SceneAppIsHome,
          r = u.d.settings.get("/settings/dashboard/allowAppQuitting"),
          s = !(
            null != (e = u.d.settings.get("/settings/dashboard/arcadeMode")) &&
            e
          ),
          l = u.d.apps && u.d.apps.find((e) => e.key == t);
        let p = !1;
        switch (o) {
          case a.w.Quitting:
          case a.w.Starting:
        ...
        return c.createElement(
          ...
          c.createElement(
            ...
            s &&
              c.createElement(
                q.e,
                { icon: q.f.PopOut, onClick: this.onOpenAppVideoSettings },
    ...
    Object(r.b)([s.bind], X.prototype, "onExitApp", null),
      Object(r.b)([s.bind], X.prototype, "onReturnToGame", null),
      Object(r.b)(
        [s.bind],
        X.prototype,
        "onOpenAppControllerBindingSettings",
      ...
      Object(r.b)([s.bind], X.prototype, "onOpenAppVideoSettings", null);
    var Q,
      Y,
      J,
      Z = n("Vp/w"),
    ...
    let ae = (Q = class extends c.Component {
      constructor(e) {
        super(e),
          ...
          (this.m_sOverlayToSwitchToOnLoad = p.r),
          ...
          this.m_mailbox.Init(Q.k_sDashboardMailboxName).then(() => {
            this.m_mailbox.RegisterHandler(
              ...
              this.m_mailbox.RegisterHandler(
                Q.k_sOverlayKeyboardClosedMessage,
              ...
              this.m_mailbox.RegisterHandler(
                Q.k_sLaserMouseSuppressionUpdate,
        ...
        (window.Dashboard = this),
          ...
          (this.m_linkStreamActiveEventHandle =
            null === (t = VRHTML) || void 0 === t
              ? void 0
              : t.RegisterForLinkStreamActiveEvents(
                  this.onLinkStreamActiveEvents
                ));
        const o =
            null === (n = VRHTML) || void 0 === n
              ? void 0
              : n.GetVRStartupReason(),
          i =
            o == a.G.AppLaunch_Unknown ||
            o == a.G.AppLaunch_Steam ||
            o == a.G.Unknown,
          r = u.d.settings.get(
            "/settings/dashboard/allowDashboardAutoLaunchWithSteamVRHome"
          ),
          s = u.d.settings.get("/settings/steamvr/enableHomeApp"),
          l = u.d.settings.get(p.m);
        ((i || (!r && s)) && !l) ||
          setTimeout(() => {
            var e;
            return null === (e = VRHTML) || void 0 === e
              ? void 0
              : e.VROverlay.ShowDashboard(null != l ? l : "");
          }, 500),
          (this.m_appStateChangedAutorunDisposer = Object(g.e)(() => {
            const e = K.a.Instance.SceneApplicationState != a.w.None;
            this.isOverlayActive(p.p) && !e && this.switchToOverlay(p.r);
          })),
      ...
      componentWillUnmount() {
        clearTimeout(this.m_timeoutHoverStateEnd),
          ...
          this.m_appStateChangedAutorunDisposer &&
            (this.m_appStateChangedAutorunDisposer(),
            (this.m_appStateChangedAutorunDisposer = null)),
          Object(a.jb)({ color_mult: 1, reflection_mult: 1 }),
          this.m_roomViewChangedEventHandle &&
      ...
      static getDashboardScale() {
        ...
        let n = 1;
        const o = u.d.settings.get(p.q),
          i = o == Y.Screenshot_Only;
        return (
          (n = i ? 2 : o == Y.Near ? 0.36 : o == Y.Middle ? 0.41 : 0.47),
          i ||
            (n *=
              null !=
              (t =
      ...
      onUpdateWindowList(e) {
        ...
        e.windows.forEach((e) => {
          ...
          this.setState({
            mapWindows: n,
            bWindowViewEnabled: ((t = u.d.settings.get(p.w)), null == t || t),
          });
      }
      onUpdateDebugInfo(e) {
        let t = {
      ...
      onDockOverlay(e, t, n) {
        var o, i;
        if (
          ((t != b.i.LeftHand && t != b.i.RightHand) ||
            this.state.mapOverlayState.forEach((e, n) => {
              e.dockLocation == t && (e.dockLocation = b.i.Dashboard);
            }),
          ...
          if (e.startsWith(p.L)) {
            const t = Number.parseInt(e.substring(p.L.length + 1));
        ...
        for (let t in this.m_mapExternalOverlays) {
          ...
          (void 0 === n.icon_overlay_key && null == n.icon_uri) ||
            (n.summon_overlay_key &&
              n.summon_overlay_key != p.D &&
              n.summon_overlay_key != p.H &&
              n.summon_overlay_key != p.I &&
              (n.summon_overlay_key.startsWith(p.L) ||
                n.summon_overlay_key.startsWith(p.N) ||
                n.summon_overlay_key.startsWith(p.J) ||
                re(n.summon_overlay_key) ||
                e.push(n)));
        }
      ...
      hideMessageOverlay() {
        this.getActiveOverlaySummonKey() == p.B && this.switchToOverlay(p.r);
      }
      show(e) {
      ...
      onRecenterClick() {
        ...
        if (this.state.bLinkStreamActive)
          ...
          this.m_mailbox.SendMessage(oe.b, {
            type: oe.a,
            countdown_seconds: 3,
          });
      }
      ...
      renderPowerMenu() {
        ...
        const t = !!(null === (e = VRHTML) || void 0 === e
            ? void 0
            : e.SceneAppRunning()),
          n = u.d.settings.get("/settings/dashboard/allowAppQuitting"),
          o = u.d.settings.get("/settings/dashboard/allowSystemShutdown");
        let i = !1;
        if (VRHTML) {
          VRHTML.VROverlay.GetPrimaryDashboardDevice() >= 0 &&
            (i = VRHTML.VRProperties.GetBoolProperty(
              ...
              a.z.DeviceCanPowerOff_Bool
            ));
        }
        const r = K.a.Instance.SceneAppName,
          s = K.a.Instance.SceneAppIsHome;
        let l, d;
        (l = s
        ...
        const m = this.findDashboardTab(p.H);
          ...
          c.createElement(
            ...
            m &&
              c.createElement(b.k, {
                ...
                lineBelow: !0,
                onClick: () => {
                  this.switchToOverlay(p.H), this.showPopupMenu(J.None);
                },
              }),
            i &&
              c.createElement(b.k, {
      ...
      renderStatusBarTitle() {
        ...
        return i.summon_overlay_key == p.c
          ? c.createElement(b.n, {
      ...
      get isDarkMode() {
        return (
          (this.state.bDesktopDarkMode && this.isOverlayActive(p.k)) ||
          this.state.bTheaterMode
        );
      }
      get screenshotMode() {
        return u.d.settings.get(p.q) == Y.Screenshot_Only;
      }
      get isTheaterMode() {
      ...
      getCollisionBoundsFadeVisualizationElements() {
        ...
        if (!n) return [];
        let o = [];
        const i = null != (t = u.d.settings.get(p.g)) ? t : 0.7;
        for (let e of n) {
          let t = Object(a.Z)(Object(a.lb)(e[3], e[0])),
            n = Object(a.Z)(Object(a.lb)(e[1], e[0])),
            r = Object(a.h)(t, n),
            s = Object(a.U)(Object(a.b)(t, n, r)),
            l = Object(a.P)(Object(a.lb)(e[0], e[3]));
          if (l < 0.4) continue;
          ...
          for (let t = 0; t < d; t++) {
            let n = (t + 1) / (d + 1),
              r = Object(a.g)();
            (r.rotation = s),
              (r.translation = Object(a.Q)(n, e[0], e[3])),
            ...
            let l = c.createElement(
              ...
              c.createElement(
                ...
                c.createElement(
                  ...
                  c.createElement(a.gb, {
                    source: "laser_pointer",
                    wireframe: !1,
                    culling: a.v.Backface,
                  })
                )
              )
            );
      ...
      render() {
        ...
        const n =
            null !=
            (e = u.d.settings.get("/settings/dashboard/theaterModeBrightness"))
              ? e
              : 1,
          o =
            null !=
            (t = u.d.settings.get("/settings/dashboard/theaterModeReflection"))
              ? t
              : 1;
        if (this.state.bShown) {
          const e =
              this.m_setSuppressingFade.size > 0 &&
              this.getActiveOverlaySummonKey() == p.D,
            t = u.d.settings.get(
              "/settings/dashboard/omitDashboardFadeWithSteamVRHome"
            ),
            i = !K.a.Instance.SceneAppIsHome || !t;
          this.screenshotMode
            ? Object(a.jb)({ color_mult: 0, reflection_mult: 0 })
            : i && !e
            ? this.isTheaterMode
              ? Object(a.jb)({
              ...
              : this.isDarkMode
              ? Object(a.jb)({ color_mult: 0.1, reflection_mult: 1 })
              : K.a.Instance.SceneApplicationState !== a.w.None
              ? Object(a.jb)({ color_mult: 0.15, reflection_mult: 1 })
              : Object(a.jb)({ color_mult: 1, reflection_mult: 1 })
            : Object(a.jb)({ color_mult: 1, reflection_mult: 1 });
        } else Object(a.jb)({ color_mult: 1, reflection_mult: 1 });
      ...
      get statusBarAnchorID() {
        let e = this.getActiveOverlayKey(),
          t =
            ...
            (this.state.mapOverlayState.get(e).dockLocation == b.i.LeftHand ||
              this.state.mapOverlayState.get(e).dockLocation == b.i.RightHand);
        return re(this.getActiveOverlaySummonKey()) || t
          ? b.t
      ...
      getPeerButtonInfo() {
        ...
        const t =
          null === (e = VRHTML) || void 0 === e
            ? void 0
            : e.VRProperties.GetStringProperty(0, a.z.PeerButtonInfo_String);
      ...
      renderControlBar(e, t) {
        ...
        const y = this.state.bLaserMouseSuppressionActive ? 0.1 : 1,
          ...
          O = Q.k_nControlBarWidthMeters,
          E =
            null ==
              (n = u.d.settings.get("/settings/dashboard/showPowerOptions")) ||
            n,
          I =
            null == (o = u.d.settings.get("/settings/dashboard/showDesktop")) ||
            o,
          M =
            null ==
              (i = u.d.settings.get("/settings/dashboard/showQuickStore")) || i,
          k = !(
            null != (r = u.d.settings.get("/settings/dashboard/arcadeMode")) &&
            r
          ),
          D = this.getPeerButtonInfo(),
          w = VRHTML.BIsLinkServer(),
          T = (VRHTML.BIsLinkClient(), this.state.bLinkStreamActive || w),
          B = K.a.Instance.SceneApplicationState,
          A = K.a.Instance.SceneAppIsHome,
          N =
            null ==
              (s = u.d.settings.get("/settings/dashboard/allowCurvature")) || s
              ? p.j
              : null,
          P = K.a.Instance.SceneAppKey;
        let L = "images/appimage_default.png";
        P && (L = "/app/image?app_key=" + P);
        const x = null != (l = u.d.settings.get(p.d)) && l,
          V = null != (m = u.d.settings.get(p.e)) ? m : 0;
        let j = x && V > 0,
          F =
            null !=
              (g = u.d.settings.get("/settings/dashboard/allowTheaterMode")) &&
            g,
          H = !0;
        ...
        let U = { y: -0.25, z: 0 };
        return (
          this.isOverlayActive(p.k) && (U = { y: -0.4, z: 0 }),
          c.createElement(
            a.ab,
            { value: y },
            c.createElement(
                                ...
                                c.createElement(
                                  ...
                                  c.createElement(
                                    ...
                                    c.createElement(b.l, {
                                      ...
                                      active: this.isOverlayActive(p.p),
                                      style: b.d.App,
                                      imageUrl: L,
                                      onClick: () => this.switchToOverlay(p.p),
                                    })
                                  )
                                )
                              )
                    ...
                    c.createElement(
                      ...
                      c.createElement(
                        ...
                        j &&
                          c.createElement(b.b, {
                            ...
                            active:
                              null === (_ = VRHTML) || void 0 === _
                                ? void 0
                                : _.VRControlPanel.GetCameraRoomViewVisible(),
                            enabled:
                              null === (S = VRHTML) || void 0 === S
                                ? void 0
                                : S.VROverlayInternal.HasCameraRoomViewCapability(),
                          }),
                        c.createElement(b.p, {
                      ...
                      k &&
                        c.createElement(b.l, {
                          ...
                          active: this.isOverlayActive(p.D),
                          enabled: this.hasOverlay(p.D),
                          label: Object(h.c)("#Settings"),
                          style: b.d.Small,
                          centerPanelAnchorID: "VolumeButton",
                          onClick: () => this.switchToOverlay(p.D),
                        }),
                      T &&
                        D &&
                        c.createElement(b.l, {
                          ...
                          active: !1,
                          enabled: !0,
                          label: Object(h.c)(D.sButtonName),
                          style: b.d.Small,
                          centerPanelAnchorID: "VolumeButton",
            ...
            c.createElement(
              ...
              c.createElement(a.V, {
                mountedId: Object(a.f)(p.F, "system.keyboard"),
              })
            )
          )
        );
      ...
      renderOverlayWidgets() {
        let e = Array.from(this.state.mapOverlayState, ([e, t]) => ({
          sOverlayKey: e,
          overlayState: t,
        })).filter((e) => e.overlayState.dockLocation != b.i.Dashboard);
        return c.createElement(
          c.Fragment,
          null,
          e.map((e) =>
      ...
      isDesktopViewVisible() {
        let e = this.getActiveOverlayKey(),
          t =
            !this.state.mapOverlayState.has(e) ||
            this.state.mapOverlayState.get(e).dockLocation == b.i.Dashboard;
        return this.state.bShown && this.isOverlayActive(p.k) && t;
      }
      onGameLaunched(e) {
        var t, n;
        const o =
          null !=
            (t = u.d.settings.get("/settings/dashboard/allowTheaterMode")) && t;
        ...
        return c.createElement(
          ...
          c.createElement(
            a.j,
            {
              ...
              summonOverlayKey: p.s,
            },
            c.createElement(x, {
              visible: this.state.bShown && this.isOverlayActive(p.s),
            })
          ),
          c.createElement(
            a.j,
            { tabName: Object(h.c)("#Now_Playing"), summonOverlayKey: p.p },
            c.createElement(X, {
              visible: this.state.bShown && this.isOverlayActive(p.p),
              onExitGame: () => this.switchToOverlay(p.r),
            })
          ),
          c.createElement(
            a.j,
            {
              ...
              tabName:
                r > 1 ? Object(h.c)("#Desktop_X", i) : Object(h.c)("#Desktop"),
          ...
          c.createElement(ee.a, {
            visible: this.state.bShown && this.isOverlayActive(p.D),
          })
        );
      }
      toggleKeyboard() {
      ...
      renderOverlayControlBar() {
        ...
        if (l) {
          ...
          (r =
            !!e && VRHTML.VROverlay.GetFlag(e, a.E.EnableControlBarKeyboard)),
            (s = !!e && VRHTML.VROverlay.GetFlag(e, a.E.EnableControlBarClose));
        }
        const d =
            null != (e = u.d.settings.get("/settings/dashboard/scaleSliderMin"))
              ? e
              : 0.75,
          m =
            null != (t = u.d.settings.get("/settings/dashboard/scaleSliderMax"))
              ? t
              : 1.5,
          g =
            null ==
              (n = u.d.settings.get("/settings/dashboard/allowCurvature")) || n
              ? p.j
              : null,
          _ = { x: 0, y: -0.15, z: 0.1 };
        return c.createElement(
                    ...
                    c.createElement(b.o, {
                      ...
                      onClick: () => {
                        ...
                        this.state.mapOverlayState.get(e).dockLocation ==
                          b.i.LeftHand
                          ? this.onDockOverlay(e, b.i.Dashboard)
                          : this.onDockOverlay(e, b.i.LeftHand);
                      },
                      enabled:
                        VRHTML.VRSystem.GetTrackedDeviceIndexForControllerRole(
                          a.x.TrackedControllerRole_LeftHand
                        ) != a.qb,
                      active:
                    ...
                    c.createElement(b.o, {
                      ...
                      onClick: () => {
                        ...
                        this.state.mapOverlayState.get(e).dockLocation ==
                          b.i.RightHand
                          ? this.onDockOverlay(e, b.i.Dashboard)
                          : this.onDockOverlay(e, b.i.RightHand);
                      },
                      enabled:
                        VRHTML.VRSystem.GetTrackedDeviceIndexForControllerRole(
                          a.x.TrackedControllerRole_RightHand
                        ) != a.qb,
                      active:
                        this.state.mapOverlayState.has(
                          this.getActiveOverlayKey()
                    ...
                    c.createElement(b.o, {
                      ...
                      onClick: () => {
                        ...
                        this.state.mapOverlayState.get(e).dockLocation ==
                          b.i.World
                          ? this.onDockOverlay(e, b.i.Dashboard)
                          : this.onDockOverlay(e, b.i.World);
                      },
                      active:
                        this.state.mapOverlayState.has(
                          this.getActiveOverlayKey()
      ...
      renderDashboard() {
        ...
        const r = this.computeFilteredOverlayTabs(),
          s = this.isDarkMode ? { r: 0.02, g: 0.02, b: 0.02 } : null;
        let l = [],
          m = [],
          g = null != (e = u.d.settings.get(p.o)) ? e : 2;
        if (r.length > g) {
          const e = u.d.settings.get(p.A);
          (l = [
            ((t = r.find((t) => t.summon_overlay_key == e)),
            null != t ? t : r[0]),
          ]),
            (m = r.filter((e) => !l.includes(e)));
        } else l = r;
        let _ = null;
        ...
        if (E) {
          ...
          (O = !!e && VRHTML.VROverlay.GetFlag(e, a.E.EnableControlBar)),
            (C =
              !this.state.mapOverlayState.has(E) ||
              this.state.mapOverlayState.get(E).dockLocation == b.i.Dashboard),
            (f =
              this.state.mapOverlayState.has(E) &&
              this.state.mapOverlayState.get(E).dockLocation == b.i.World);
        }
        this.state.bLaserMouseSuppressionActive && (O = !1);
        let I = 2,
          M = 2.5;
        const k = u.d.settings.get("/settings/dashboard/theaterPosition");
        k == Y.Near
          ? ((I *= 1), (M *= 1))
          : k == Y.Middle
          ? ((I *= 4), (M *= 2.5))
        ...
        const D =
            ...
            (n =
              0.01 *
              u.d.settings.get("/settings/dashboard/theaterVerticalOffsetCm"))
              ? n
              : 0,
          R =
            null ==
              (o = u.d.settings.get("/settings/dashboard/allowCurvature")) || o,
          w = R ? p.j : null;
        let T,
          B,
          A,
          ...
          x = this.state.bTheaterMode
            ? { y: -1.2, z: 1 }
            : { y: -1.2, z: 0.15 },
          V = this.state.bTheaterMode
            ? { x: 0.75, y: 0.75, z: 0.75 }
            : { x: 1, y: 1, z: 1 },
          j = !R && this.state.bTheaterMode ? 0.75 : 1,
          F = R ? 1 : 0;
        return (
          this.state.bTheaterMode
            ? ((T = { y: -0.8 * M + D, z: -I }),
          ...
          c.createElement(
            ...
            c.createElement(a.ob, { id: w, translation: { z: y } }),
            c.createElement(
              a.ob,
              {
                translation: {
                  ...
                  z: -Q.getDashboardDistance() * (S ? 1.1 : 1),
                },
                rotation: { x: S ? -20 : 0 },
                  ...
                  c.createElement(
                    ...
                    c.createElement(
                      ...
                      c.createElement(
                        ...
                        c.createElement(b.m, {
                          role: a.x.TrackedControllerRole_LeftHand,
                      ...
                      c.createElement(
                        ...
                        c.createElement(b.g, null)
                      ),
                      c.createElement(
                        "div",
                        { className: "Section Right" },
                        c.createElement(b.m, {
                          role: a.x.TrackedControllerRole_RightHand,
                          style: te.b.HorizontalPips,
                        }),
                        c.createElement(
                          "div",
              ...
              c.createElement(
                ...
                c.createElement(
                  a.ob,
                  { scale: { x: B, y: B } },
                  !f && C && this.renderActiveOverlay(),
                  !f &&
                    !C &&
                    c.createElement(
                      b.h,
                      {
                        additionalClassNames: O ? "WithControlBar" : "",
                        visible: !0,
                      },
                      c.createElement(
                        "div",
                  ...
                  L &&
                    c.createElement(
                      ...
                      c.createElement(a.N, {
                        ...
                        "far-z": 1,
                        debug: !1,
                        specular: { color: { r: 0.05, g: 0.05, b: 0.05 } },
                        diffuse: { size: P, resolution: 512 },
                      })
                    )
                )
              ),
              O && C && this.renderOverlayControlBar(),
              c.createElement(
                a.ob,
                { translation: x, scale: V },
                c.createElement(
                  a.ob,
                  { rotation: { x: -35 }, curvature_pitch: -35 },
                  this.renderControlBar(l, m)
                ),
    ...
    (ae.k_sDashboardMailboxName = "systemui_dashboard"),
      ...
      (ae.k_sOverlayKeyboardClosedMessage = "overlay_keyboard_closed"),
      (ae.k_sDashboardOverlayCreatedMessage = "dashboard_overlay_created"),
      (ae.k_sDashboardOverlayDestroyedMessage = "dashboard_overlay_destroyed"),
      ...
      (ae.k_sLaserMouseSuppressionUpdate = "laser_mouse_suppression_update"),
      ...
      Object(r.b)([s.bind], ae.prototype, "onRoomViewChanged", null),
      Object(r.b)([s.bind], ae.prototype, "onLinkStreamActiveEvents", null),
      Object(r.b)(
        [s.bind],
        ae.prototype,
      ...
      Object(r.b)([s.bind], ae.prototype, "onDashboardOverlayCreated", null),
      Object(r.b)([s.bind], ae.prototype, "onDashboardOverlayDestroyed", null),
      Object(r.b)([s.bind], ae.prototype, "onUpdateDashboardTabs", null),
      Object(r.b)([s.bind], ae.prototype, "onWindowViewCreated", null),
      Object(r.b)([s.bind], ae.prototype, "onWindowViewDestroyed", null),
      Object(r.b)([s.bind], ae.prototype, "onUpdateWindowList", null),
      Object(r.b)([s.bind], ae.prototype, "onUpdateDebugInfo", null),
      Object(r.b)([s.bind], ae.prototype, "onDockOverlay", null),
      Object(r.b)([s.bind], ae.prototype, "show", null),
      Object(r.b)([s.bind], ae.prototype, "hide", null),
      Object(r.b)([s.bind], ae.prototype, "setPlacementModeActive", null),
      Object(r.b)([s.bind], ae.prototype, "onToggleRoomView", null),
      Object(r.b)([s.bind], ae.prototype, "onQuickLaunchButtonClick", null),
      Object(r.b)([s.bind], ae.prototype, "onQuickStoreButtonClick", null),
      Object(r.b)([s.bind], ae.prototype, "onRecenterClick", null),
      Object(r.b)([s.bind], ae.prototype, "renderPowerMenu", null),
      Object(r.b)([s.bind], ae.prototype, "startPopupMenuTimeout", null),
      Object(r.b)([s.bind], ae.prototype, "clearPopupMenuTimeout", null),
      Object(r.b)([s.bind], ae.prototype, "showPopupMenu", null),
      Object(r.b)([s.bind], ae.prototype, "popupMenuMouseLeave", null),
      Object(r.b)([s.bind], ae.prototype, "popupMenuMouseUp", null),
      Object(r.b)([g.f], ae.prototype, "isDarkMode", null),
      Object(r.b)([g.f], ae.prototype, "screenshotMode", null),
      Object(r.b)([g.f], ae.prototype, "isTheaterMode", null),
      Object(r.b)(
        [s.bind],
        ae.prototype,
      ...
      Object(r.b)([s.bind], ae.prototype, "isDesktopTrayActive", null),
      Object(r.b)([s.bind], ae.prototype, "isDesktopOverlayActive", null),
      Object(r.b)([s.bind], ae.prototype, "handlePeerButton", null),
      Object(r.b)([s.bind], ae.prototype, "isDesktopViewVisible", null),
      Object(r.b)([s.bind], ae.prototype, "onGameLaunched", null),
      Object(r.b)([s.bind], ae.prototype, "toggleKeyboard", null),
      Object(r.b)([s.bind], ae.prototype, "onKeyboardClosed", null),
      Object(r.b)([g.f], ae.prototype, "activeOverlayScale", null),
      Object(r.b)([s.bind], ae.prototype, "onActiveOverlayScaleChange", null),
      Object(r.b)([s.bind], ae.prototype, "onActiveOverlayClosed", null),
      Object(r.b)([g.m], ae, "s_dashboardUserDistance", void 0),
      Object(r.b)([g.m], ae, "s_dashboardUserScale", void 0),
      (ae = Q = Object(r.b)([m.a], ae));
  },
  N46P: function (e, t, n) {
    "use strict";
    n.d(t, "a", function () {
  ...
  VyMh: function (e, t, n) {
    ...
    let f = class extends i.Component {
      ...
      render() {
        ...
        n.push(new S.b("none", Object(p.c)("#SourceInputMode_none")));
        let o =
    ...
    class O extends i.Component {
      ...
      AddNoneItems(e) {
        e.push(new S.b("-blank", "")),
          e.push(new S.b("none", Object(p.c)("#SourceInputAction_none")));
      }
      AddBlankItem(e) {
        e.push(new S.b("-blank", ""));
      }
      AddNoActionsItem(e) {
        e.push(new S.b("-nonitem", Object(p.c)("#SourceInputAction_NoItems")));
      }
      AddHeaderItem(e, t) {
        e.push(new S.b("-subHeader", Object(p.c)(t)));
      }
    ...
    let D = class extends O {
      ...
      renderSettingsContent() {
        let e = this.props.controllerWatcher[0].GetInputSource,
          t = [];
        e.click &&
          t.push(new S.b("click", this.LocalizeForceInputModeString("click"))),
          e.value &&
            t.push(
              new S.b("value", this.LocalizeForceInputModeString("value"))
            ),
          e.force &&
            t.push(
              new S.b("force", this.LocalizeForceInputModeString("force"))
            ),
          t.length > 1 &&
            t.push(new S.b("", this.LocalizeForceInputModeString("")));
        let n = void 0,
          o = void 0,
          r = void 0,
    ...
    let R = class extends O {
      ...
      renderSettingsContent() {
        ...
        t.length > 1 && t.push("");
        for (let e of t)
          n.push(new S.b(e, this.LocalizeForceInputModeString(e)));
        let o = void 0,
          r = void 0,
          a = void 0,
    ...
    let B = class extends O {
      ...
      render() {
        let e = this.props.controllerWatcher[0],
          ...
          o = [
            new S.b("click", Object(p.c)("#SourceInputMode_Click")),
            new S.b("touch", Object(p.c)("#SourceInputMode_Touch")),
          ],
          r =
            (this.state.sSubMode,
    ...
    let N = class extends O {
      ...
      renderSettingsContent() {
        ...
        this.hasOwnProperty("nextUniqueId") && (e = this.nextUniqueId());
        let t = [
            new S.b("smooth", this.LocalizeScrollModeString("smooth")),
            new S.b("discrete", this.LocalizeScrollModeString("discrete")),
          ],
              ...
              i.createElement(
                ...
                _ &&
                  i.createElement(
                    y.a,
                    {
                      content: Object(p.c)("#BindingUI_ChordsButton_tooltip"),
                      theme: "MainButton",
                    },
                    i.createElement(
                      "div",
                      ...
                      Object(p.c)("#BindingUI_ChordsButton")
                    )
                  ),
                h.a.BSelectedActionSetHasPoses &&
                  i.createElement(
                    y.a,
                    {
                      content: Object(p.c)("#BindingUI_PosesButton_tooltip"),
                      theme: "MainButton",
                    },
                    i.createElement(
                      "div",
                      ...
                      Object(p.c)("#BindingUI_PosesButton")
                    )
                  ),
                h.a.BSelectedActionSetHasHaptics &&
                  i.createElement(
                    y.a,
                    {
                      content: Object(p.c)("#BindingUI_HapticsButton_tooltip"),
                      theme: "MainButton",
                    },
                    i.createElement(
                      "div",
                      ...
                      Object(p.c)("#BindingUI_HapticsButton")
                    )
                  ),
                h.a.BSelectedActionSetHasSkeletons &&
                  i.createElement(
                    y.a,
                    {
                      content: Object(p.c)("#BindingUI_SkeletonButton_tooltip"),
                      theme: "MainButton",
                    },
                    i.createElement(
                      "div",
                      ...
                      Object(p.c)("#BindingUI_SkeletonButton")
                    )
                  )
              ),
              c &&
    ...
    var z;
    Object(o.b)([u.bind], W.prototype, "ToggleMirrorMode", null),
      Object(o.b)([u.bind], W.prototype, "UpdatePositionHelper", null),
      Object(o.b)(
        [u.bind],
        W.prototype,
        "OnUpdateControllerPicturePosition",
      ...
      Object(o.b)([u.bind], W.prototype, "BindLeftControllerImage", null),
      Object(o.b)([u.bind], W.prototype, "BindRightControllerImage", null),
      (W = Object(o.b)([a.a], W)),
      (function (e) {
        (e[(e.None = 0)] = "None"),
          (e[(e.Pose = 1)] = "Pose"),
      ...
      render() {
        ...
        let s = h.a.SelectedActionSetActions.filter(
          ...
          return (
            ...
            new S.b(t.name, t.localized_name, r)
          );
        });
        (null != s && 0 != s.length) ||
          s.push(
            new S.b("-nonitem", Object(p.c)("#SourceInputAction_NoItems"))
          ),
          s.unshift(new S.b("-subHeader", Object(p.c)(t))),
          s.push(new S.b("-blank", "")),
          s.push(new S.b("none", Object(p.c)("#SourceInputMode_none")));
        return i.createElement(
          "div",
          {
    ...
    Object(o.b)(
      ...
      Object(o.b)([u.bind], Q.prototype, "BindLeftControllerImage", null),
      Object(o.b)([u.bind], Q.prototype, "BindRightControllerImage", null),
      Object(o.b)([u.bind], Q.prototype, "BindPropsListDiv", null),
      (Q = Object(o.b)([a.a], Q));
        ...
        let r = e.map(
            (e, n) => (
              this.props.chord.output &&
                ...
                (t = e.localized_name),
              new S.b(e.name.toLowerCase(), e.localized_name)
            )
          ),
    ...
    Object(o.b)([u.bind], Y.prototype, "OnActionOutputChanged", null),
      Object(o.b)([u.bind], Y.prototype, "DeleteChord", null),
      Object(o.b)([u.bind], Y.prototype, "DeleteSourceFromChord", null),
      Object(o.b)([u.bind], Y.prototype, "AddSourceToChord", null),
      (Y = Object(o.b)([a.a], Y));
    ...
    class ie extends i.Component {
      ...
      render() {
        let e = h.a.SelectedAppActions.simulation_types,
          t = [];
        for (let n of e)
          "TrackedDeviceClass_Controller" == n.device_type &&
            t.push(
              new S.b(n.controller_type, Object(p.c)("#" + n.controller_type))
            );
        t.push(new S.b("none", Object(p.c)("#None")));
    ...
    class ae extends i.Component {
      ...
      render() {
        let e = h.a.GetLiteralVector1ActionBindings.map(
          (e, t) => new S.b(e.name, e.localized_name)
        );
        e.push(new S.b("none", Object(p.c)("#SourceInputAction_none")));
    ...
    class se extends i.Component {
      ...
      render() {
        ...
        h.a.GetOptionValue("mirror_actions") ||
          (e.push(new S.b("left", Object(p.c)("#TrackpadClickLeft"))),
          e.push(new S.b("right", Object(p.c)("#TrackpadClickRight"))),
          e.push(new S.b("none", Object(p.c)("#TrackpadClickNone"))));
        let t = "InputOption" + this.props.simAction.id,
          n = {
    ...
    let le = class extends i.Component {
      ...
      render() {
        ...
        return (
          e.push(
            new S.b("fake_trigger", Object(p.c)("#SimulatedAction_FakeTrigger"))
          ),
          e.push(
            new S.b(
              "fake_trackpad_click",
    ...
    let ce = class extends i.Component {
      ...
      render() {
        var e;
        let t = "openxr" == h.a.SelectedAppActions.category,
          n =
            (null === (e = h.a.SelectedAppActions.interaction_profiles) ||
            void 0 === e
              ? void 0
              : e.length) > 0,
          o = h.a.GetOptionValue("simulated_controller_type"),
          r = o && "none" != o;
        return i.createElement(
          "div",
          { className: "FlexColumn ChordBindingModal" },
          i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                "div",
                { className: "Label Title TitleCenter AllCaps" },
                Object(p.c)("#BindingUI_OptionsTitle")
              )
            )
          ),
          i.createElement(
            ...
            t && n && i.createElement(de, { bReadOnly: this.props.bReadOnly }),
            !t &&
              i.createElement(pe, {
    ...
    ce = Object(o.b)([a.a], ce);
    class de extends i.Component {
      constructor(e) {
        super(e);
        let t = h.a.GetInteractionProfile();
        t || (t = " "), (this.state = { sValue: t });
      }
      OnInteractionProfileDropdownChanged(e) {
        h.a.SetInteractionProfile(e), this.setState({ sValue: e });
      }
      render() {
        let e = h.a.GetInteractionProfiles(),
          t = [];
        return (
          e.forEach(function (e) {
            let n = e.replace("/interaction_profiles/", "");
            t.push(new S.b(e, n, null, e));
          }),
          t.push(new S.b(" ", Object(p.c)("#None"))),
          i.createElement(
            "div",
            { className: "FlexRow SetupLegacyRow" },
            i.createElement(
              ...
              i.createElement(
                ...
                Object(p.c)("#BindingUI_Options_InteractionProfile_Label")
              )
            ),
            i.createElement(
              "div",
              ...
              i.createElement(
                ...
                i.createElement(
                  ...
                  i.createElement(S.a, {
                    ...
                    sModalClass: "PinTop",
                    sValueSelectedItem: this.state.sValue,
                    fnOptionSelected: this.OnInteractionProfileDropdownChanged,
                    bReadOnly: this.props.bReadOnly,
                  })
                )
              )
    ...
    class pe extends i.Component {
      ...
      render() {
        ...
        for (let t of this.option_items)
          e.push(new S.b(t.sValue, t.sName, null, t.sValue));
        return (
          this.props.bAllowNone &&
            e.push(new S.b("none", Object(p.c)("#None"))),
          i.createElement(
            "div",
            { className: "FlexRow SetupLegacyRow" },
            i.createElement(
    ...
    Object(o.b)([u.bind], pe.prototype, "OnStringDropdownChanged", null);
    class he extends i.Component {
      constructor(e) {
        super(e);
        let t = h.a.GetOptionValue(e.sOptionName);
        t || (t = !1), (this.state = { bValue: t });
      }
      onCheckboxChanged(e) {
        h.a.SetOptionValue(this.props.sOptionName, e),
          this.setState({ bValue: e });
    ...
    Object(o.b)([u.bind], he.prototype, "onCheckboxChanged", null);
    var ue,
      me = n("p9CI");
    !(function (e) {
      (e[(e.None = 0)] = "None"),
    ...
    let be = class extends i.Component {
      ...
      GetSaveTypeString(e) {
        switch (e) {
          ...
          case ue.LocalFile:
            return "local_file";
          case ue.AddNewDefault:
          case ue.ReplaceDefault:
      ...
      render() {
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            this.props.eSaveType == ue.Personal &&
              i.createElement(
                "div",
                { className: "Label Title" },
                Object(p.c)("#BindingUI_Save_Personal")
              ),
            this.props.eSaveType == ue.Public &&
              i.createElement(
                "div",
                { className: "Label Title" },
                Object(p.c)("#BindingUI_Save_Public")
              ),
            this.props.eSaveType == ue.LocalFile &&
              i.createElement(
                "div",
                { className: "Label Title" },
                Object(p.c)("#BindingUI_Save_Export")
              ),
            (this.props.eSaveType == ue.ReplaceDefault ||
              this.props.eSaveType == ue.AddNewDefault) &&
              i.createElement(
                "div",
                { className: "Label Title" },
    ...
    Object(o.b)([u.bind], be.prototype, "CloseSaveDialog", null),
      Object(o.b)([u.bind], be.prototype, "ConfirmBindingName", null),
      Object(o.b)([u.bind], be.prototype, "BindNameInput", null),
      Object(o.b)([u.bind], be.prototype, "BindDescriptionInput", null),
      Object(o.b)([u.bind], be.prototype, "OnNameFocus", null),
      Object(o.b)([u.bind], be.prototype, "OnOverlayNameText", null),
      Object(o.b)([u.bind], be.prototype, "OnDescriptionFocus", null),
      Object(o.b)([u.bind], be.prototype, "OnOverlayDescriptionText", null),
    ...
    let ve = class extends i.Component {
      ...
      OnActionSetDropdownChanged(e) {
        this.setState({ eTabType: _e.ActionSet }), h.a.SetSelectedActionSet(e);
      }
      ...
      CloseSaveModal() {
        this.setState({ eSaveType: ue.None });
      }
      ShowPublicModal() {
        this.setState({ eSaveType: ue.Public });
      }
      ShowPersonalModal() {
        this.setState({ eSaveType: ue.Personal });
      }
      ShowExportModal() {
        this.setState({ eSaveType: ue.LocalFile });
      }
      ShowReplaceDefaultModal() {
        ...
        this.setState({ eSaveType: e ? ue.ReplaceDefault : ue.AddNewDefault });
      }
      ...
      OnLegacySetup() {
        this.setState({ eTabType: _e.LegacySetup });
      }
      OnSecondaryControllerSetup() {
        this.setState({ eTabType: _e.SecondaryControllerSetup });
      }
      render() {
          ...
          t = e.map((e, t) => {
            ...
            return (
              ...
              e.name == h.a.SelectedActionSet &&
                this.state.eTabType == _e.ActionSet &&
                (n += " Selected"),
              i.createElement(
                "div",
                {
        ...
        if (h.a.SelectedBindingIsLegacy || h.a.ManifestOptions.length > 0) {
          ...
          this.state.eTabType == _e.LegacySetup && (e += " Selected"),
            t.push(
              i.createElement(
                "div",
                {
        ...
        if (h.a.IsSecondaryController) {
          let e = "Label Tab PositionRelative";
          this.state.eTabType == _e.SecondaryControllerSetup &&
            (e += " Selected"),
            t.push(
              i.createElement(
                "div",
        ...
        let u = Z.a.GetApp(h.a.SelectedApp),
          b = "";
        u && (b = u.name);
        let g,
          ...
          v = "#BindingUI_PageSubTitle",
          S = h.a.GetOptionValue("variant");
        S &&
          ((g = Object(p.c)("#BindingVariant_" + S)),
          (v = "#BindingUI_PageSubTitle_WithVariant"));
        let y = Object(p.c)(
            v,
            h.a.SelectedControllerTypeLocalizedName,
            b,
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            e.length > 0 &&
              i.createElement(
                me.b,
                {
                  scrollDirection: me.a.Horizontal,
                  className: Object(d.a)("ActionTabContainer", "TabRow"),
                },
                t
              ),
            this.state.eTabType == _e.ActionSet &&
          ...
          this.state.eTabType == _e.LegacySetup &&
            i.createElement(
              "div",
    ...
    Object(o.b)([u.bind], ve.prototype, "OnAppDropdownChanged", null),
      Object(o.b)([u.bind], ve.prototype, "OnActionSetDropdownChanged", null),
      Object(o.b)([u.bind], ve.prototype, "ToggleDeveloperOutput", null),
      Object(o.b)([u.bind], ve.prototype, "OpenPoseBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "ClosePoseBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "OpenHapticsBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "CloseHapticsBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "OpenSkeletonBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "CloseSkeletonBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "OpenChordBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "CloseChordBindingsModal", null),
      Object(o.b)([u.bind], ve.prototype, "OpenOptionsModal", null),
      Object(o.b)([u.bind], ve.prototype, "CloseOptionsModal", null),
      Object(o.b)([u.bind], ve.prototype, "CloseSaveModal", null),
      Object(o.b)([u.bind], ve.prototype, "ShowPublicModal", null),
      Object(o.b)([u.bind], ve.prototype, "ShowPersonalModal", null),
      Object(o.b)([u.bind], ve.prototype, "ShowExportModal", null),
      Object(o.b)([u.bind], ve.prototype, "ShowReplaceDefaultModal", null),
      Object(o.b)([u.bind], ve.prototype, "ShowUnboundActionsOverlay", null),
      Object(o.b)([u.bind], ve.prototype, "HideUnboundActionsOverlay", null),
      Object(o.b)([u.bind], ve.prototype, "SetBindingUIInMirroredMode", null),
      Object(o.b)([u.bind], ve.prototype, "SelectThisBinding", null),
      Object(o.b)([u.bind], ve.prototype, "OnSelectBinding", null),
      Object(o.b)([u.bind], ve.prototype, "OnSelectConfirmed", null),
      Object(o.b)([u.bind], ve.prototype, "OnSelectDone", null),
      Object(o.b)([u.bind], ve.prototype, "OnSaveCurrentBinding", null),
      Object(o.b)([u.bind], ve.prototype, "renderSelectConfirmModal", null),
      Object(o.b)([u.bind], ve.prototype, "OnSaveClicked", null),
      Object(o.b)([u.bind], ve.prototype, "OnLegacySetup", null),
      Object(o.b)([u.bind], ve.prototype, "OnSecondaryControllerSetup", null),
    ...
    Object(o.b)([u.bind], ye.prototype, "CloseDialog", null),
    ...
    let fe = class extends i.Component {
      constructor(e) {
        ...
        (this.state = {
          ...
          this.props.result.steamIDOwner.length &&
            ...
            Se.a.RequestUserInformation(this.props.result.steamIDOwner);
      }
      OnDelete() {
        this.setState({ bShowDeleteConfirmModal: !0 });
      }
      ...
      render() {
        ...
        let d = void 0;
        a &&
          ((d = Se.a.GetUserInformation(o.steamIDOwner).avatar_url),
          (c = Se.a.GetUserInformation(o.steamIDOwner).persona_name));
    ...
    Object(o.b)([u.bind], fe.prototype, "OnDelete", null),
      Object(o.b)([u.bind], fe.prototype, "OnDeleteConfirmed", null),
      Object(o.b)([u.bind], fe.prototype, "OnDeleteCancel", null),
      Object(o.b)([u.bind], fe.prototype, "renderDeleteConfirmModal", null),
      Object(o.b)([u.bind], fe.prototype, "OnView", null),
      Object(o.b)([u.bind], fe.prototype, "OnSelect", null),
      (fe = Object(o.b)([a.a], fe));
    let Ce = class extends i.Component {
      constructor(e) {
        super(e);
      }
        ...
        return (
          ...
          i.createElement(
            ...
            m.a.ShowBindingListError &&
              i.createElement(ye, { sError: m.a.BindingListError })
          )
        );
      }
    };
    Object(o.b)([u.bind], Ce.prototype, "CreateBinding", null),
      Object(o.b)([u.bind], Ce.prototype, "SelectBinding", null),
      Object(o.b)([u.bind], Ce.prototype, "ViewBinding", null),
      Object(o.b)([u.bind], Ce.prototype, "OnControllerDropdownChanged", null),
      Object(o.b)([u.bind], Ce.prototype, "ComputeResultsSection", null),
      Object(o.b)([u.bind], Ce.prototype, "CreateControllerTypeDropdown", null),
      (Ce = Object(o.b)([a.a], Ce));
    ...
    Object(o.b)([u.bind], Oe.prototype, "CloseDialog", null),
      (Oe = Object(o.b)([a.a], Oe));
    let Ee = class extends i.Component {
      constructor(e) {
        super(e),
          (this.state = {
    ...
    let Ie = class extends i.Component {
      constructor(e) {
        super(e),
          (this.m_bInHeadset = !1),
          (this.m_bInHeadset = !!c.pb && !m.a.DesktopMode),
    ...
    Object(o.b)([u.bind], Ie.prototype, "SelectApplication", null),
      Object(o.b)([u.bind], Ie.prototype, "OnShowMoreApps", null),
      (Ie = Object(o.b)([a.a], Ie));
    var Me,
      ke,
      De,
      Re = n("GxMB"),
    ...
    class Ae extends i.Component {
      ...
      renderBinding(e, t) {
          ...
          );
        {
          ...
          return (
            "number" == typeof t &&
              (n += " " + Object(p.c)("#InputDebugger_PriorityValue", Be(t))),
            i.createElement(
              "div",
              {
        ...
        return i.createElement(
          ...
          "number" == typeof o &&
            i.createElement(
              "div",
              { className: "Label" },
              Object(p.c)("#InputDebugger_PriorityValue", Be(o))
            ),
    ...
    Object(o.b)([u.bind], Ae.prototype, "OnSelectApp", null),
      Object(o.b)([u.bind], Ae.prototype, "OnInputFrame", null),
      Object(o.b)([u.bind], Ae.prototype, "SetActionSet", null);
    var Ne,
      Pe = n("tUsp"),
      Le = n("Q+Z6");
    let xe = class extends i.Component {
      ...
      render() {
        ...
        return i.createElement(
          ...
          m.a.GetUIState == m.b.List && i.createElement(Ce, null),
          m.a.GetUIState == m.b.AppSelect && i.createElement(Ie, null),
          m.a.GetUIState == m.b.Debugger && i.createElement(Ae, null),
    ...
    xe = Object(o.b)([a.a], xe);
    const Ve = document.getElementById("root");
    Object(p.b)(
      ["bindingui"],
      null === (Ne = VRHTML) || void 0 === Ne ? void 0 : Ne.GetSteamVRLanguage()
    )
      .then(() => Pe.a.Init())
      .then(() => Z.a.Init())
      .then(() => j.a.Init())
          ...
          return Object(o.a)(this, void 0, void 0, function* () {
            m.a.SetDesktopMode(Object(d.d)("desktop").length > 0),
              VRHTML &&
                ...
                VRHTML.VROverlay.SetFlag(
                  VRHTML.VROverlay.ThisOverlayHandle(),
                  c.E.ShowTouchPadScrollWheel,
                  !0
                ),
                VRHTML.VROverlay.SetFlag(
                  VRHTML.VROverlay.ThisOverlayHandle(),
                  c.E.SendVRSmoothScrollEvents,
                  !0
                ),
      ...
      .then(() => {
        var e;
        (e = xe), r.render(i.createElement(e, null), Ve);
      })
  ...
  YRJX: function (e, t, n) {
    ...
    const D = "DashboardPanelTopCenter",
      ...
      T = (e) => {
        ...
        const a = null == (t = e.scrollable) || t,
          l = null != (n = e.foregroundReflectMultiplier) ? n : 1,
          c =
            null ==
              (o = O.d.settings.get("/settings/dashboard/allowCurvature")) || o
              ? m.j
              : null;
        return s.createElement(
          ...
          s.createElement(
            u.bb,
            {
              visibility: e.visible ? u.db.Visible : u.db.Hidden,
              debug_name: "homepanelbackground",
              curvature_origin_id: c,
              origin: u.t.BottomCenter,
              interactive: !1,
              scrollable: !1,
              target_dpi_panel_id: w,
              target_dpi_multiplier: 2,
              reflect: 0.01,
              sampler: u.u.SingleTap,
            },
            s.createElement(u.cb, { id: D, location: u.t.TopCenter }),
            s.createElement(
              E.a,
              { ref: i },
              s.createElement("div", {
            ...
            s.createElement(u.cb, { id: R, location: u.t.BottomCenter })
          ),
          s.createElement(
            u.ob,
            { translation: { z: 1e-5 } },
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    v.b,
                    {
                      scrollDirection: a ? v.a.Vertical : v.a.None,
                      className: Object(h.a)(
                        "DashboardPanel",
                        e.additionalClassNames
                      ),
    ...
    let N = (o = class extends s.Component {
      constructor(e) {
        super(e),
          (this.state = {
            fOverlayScale: this.GetDefaultScaleForLocation(),
            xfTransform: Object(u.g)(),
            sParent: A(this.props.dockLocation),
            bIsOutsideMaxDist: !1,
            destination: this.props.dockLocation,
            bIsMoving: !1,
          }),
          (this.m_nMoveDeviceIndex = u.qb),
          (this.m_moveDeviceRole = u.x.TrackedControllerRole_Invalid);
      }
      ...
      SetInitialTransformForLocation() {
        ...
        let e = Object(u.g)();
        switch (
          ((e.rotation = Object(u.J)({ x: -45, y: 0, z: 0 })),
      ...
      computeDestination() {
        ...
        let e = VRHTML.GetPose(this.m_nMoveDeviceIndex, u.B.Standing),
          t = null;
        VRHTML.VRSystem.GetTrackedDeviceIndexForControllerRole(
          u.x.TrackedControllerRole_LeftHand
        ) != u.qb && (t = VRHTML.GetPose("/user/hand/left", u.B.Standing));
        let n = null;
        VRHTML.VRSystem.GetTrackedDeviceIndexForControllerRole(
          u.x.TrackedControllerRole_RightHand
        ) != u.qb && (n = VRHTML.GetPose("/user/hand/right", u.B.Standing));
        let i = [];
        switch (this.state.sParent) {
          case "/user/hand/left":
            n && i.push({ pose: n, location: B.RightHand });
            break;
          case "/user/hand/right":
            t && i.push({ pose: t, location: B.LeftHand });
            break;
          case "/user/head":
            t && i.push({ pose: t, location: B.LeftHand }),
              n && i.push({ pose: n, location: B.RightHand });
        ...
        i.forEach((e) => {
          ...
          Object(u.P)(t.translation) > o.sfMaxDockDist
            ? this.state.bIsOutsideMaxDist ||
              (k.b.Instance.triggerHaptic(k.a.SlidingEdge),
              this.setState({ bIsOutsideMaxDist: !0, destination: B.World }))
            : (this.state.bIsOutsideMaxDist ||
      ...
      startMove() {
        ...
        let e,
          t,
          n = VRHTML.GetPose(this.m_nMoveDeviceIndex, u.B.Standing);
        switch (this.props.dockLocation) {
          case B.LeftHand:
            if (
              VRHTML.VRSystem.GetTrackedDeviceIndexForControllerRole(
              ...
              return;
            e = VRHTML.GetPose("/user/hand/left", u.B.Standing);
            break;
          case B.RightHand:
            if (
              VRHTML.VRSystem.GetTrackedDeviceIndexForControllerRole(
              ...
              return;
            e = VRHTML.GetPose("/user/hand/right", u.B.Standing);
            break;
          default:
            e = {
              xfDeviceToAbsoluteTracking: Object(u.g)(),
              vVelocity: { x: 0, y: 0, z: 0 },
              eTrackingResult: u.A.TrackingResult_Running_OK,
              bPoseIsValid: !0,
            };
        }
        switch (this.m_moveDeviceRole) {
          case u.x.TrackedControllerRole_LeftHand:
            t = "/user/hand/left";
            break;
          case u.x.TrackedControllerRole_RightHand:
            t = "/user/hand/right";
            break;
          default:
            t = "/user/head";
      ...
      endMove() {
        ...
        if (
          ...
          if (
            ...
            return;
          t = VRHTML.GetPose("/user/hand/right", u.B.Standing);
        }
        let n,
          o = {
            xfDeviceToAbsoluteTracking: Object(u.g)(),
        ...
        let i = VRHTML.GetPose(this.m_nMoveDeviceIndex, u.B.Standing),
      ...
      render() {
        ...
        let i =
            (null != (e = VRHTML.VROverlay.GetWidthInMeters(t)) ? e : 1) *
            this.state.fOverlayScale,
          r = (i * n.y) / n.x;
        if (!this.props.bVisible)
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(u.V, {
                mountedId: Object(u.f)(m.F, this.props.sOverlayKey + ".cursor"),
              })
            )
          );
        let a = r + o.sfOverlayTrayHeight,
          l = Math.max(i, 0.175),
          c = a / 2 - o.sfOverlayTrayHeight;
        return s.createElement(
          u.S,
          {
          ...
          s.createElement(
            u.ob,
            {
              ...
              scale: { x: l, y: a, z: 0.008 },
            },
            s.createElement(
              u.mb,
              { color: { r: 0.016, g: 0.017, b: 0.02 } },
              s.createElement(u.gb, { solid: !0, source: "unit_cube" })
            )
          ),
          s.createElement(
            u.bb,
    ...
    (N.sfMaxDockDist = 0.4),
      (N.sfMovePulseMS = 100),
      (N.sfOverlayTrayHeight = 0.025),
      (N.sfOverlayScaleMin = 0.1),
      (N.sfOverlayScaleMax = 2),
      Object(a.b)([l.bind], N.prototype, "onOverlayScaleChanged", null),
      Object(a.b)([l.bind], N.prototype, "computeDestination", null),
      Object(a.b)([l.bind], N.prototype, "startMove", null),
      Object(a.b)([l.bind], N.prototype, "endMove", null),
      (N = o = Object(a.b)([_.a], N));
    ...
    Object(a.b)([l.bind], L.prototype, "updateTime", null);
    let V = (i = class extends s.Component {
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                u.bb,
                {
                  visibility: t ? u.db.Visible : u.db.SkipInSceneGraph,
                  target_dpi_panel_id: w,
    ...
    (V.s_CurrentlyShownTooltip = null),
      Object(a.b)([b.f], V.prototype, "isShowingTooltip", null),
      Object(a.b)([b.d.bound], V.prototype, "show", null),
      Object(a.b)([b.d.bound], V.prototype, "hide", null),
      Object(a.b)([b.m], V, "s_CurrentlyShownTooltip", void 0),
      (V = i = Object(a.b)([_.a], V));
    class j extends s.Component {
      static ShouldInvertThumbnail(e) {
        ...
        if (((e = e.toLowerCase()), !j.s_mapShouldInvertThumbnail.has(e))) {
          ...
          e.endsWith(".svg") && (t = !0),
            e.startsWith("data:") &&
              j.k_rsThumbnailHashesToInvert.indexOf(M.a.hash(e)) >= 0 &&
              (t = !0),
      ...
      render() {
        ...
        const t = null != (e = this.props.shadow) && e,
          n = j.ShouldInvertThumbnail(this.props.src);
        return s.createElement(
          "div",
          { className: "Icon" },
          t &&
          ...
          s.createElement("img", {
            className: Object(h.a)(["BlackToWhite", n]),
            src: this.props.src,
          })
        );
      }
        ...
        return s.createElement(
          d.a,
          {
            className: Object(h.a)(
              "ControlBarButton",
              this.props.additionalClassNames,
              H[((e = this.props.imageStyle), null != e ? e : H.Center)] +
                "Image",
            ...
            onMouseEnter: this.onMouseEnter,
            onMouseLeave: this.onMouseLeave,
            pressSoundEffect: p.a.ControlBarButtonPress,
            releaseSoundEffect: p.a.ControlBarButtonRelease,
          },
          ...
          s.createElement(j, { src: this.props.imageUrl })
        );
      }
    };
    Object(a.b)([l.bind], G.prototype, "onMouseEnter", null),
      Object(a.b)([l.bind], G.prototype, "onMouseLeave", null),
      (G = Object(a.b)([_.a], G));
    const W = (e) =>
      s.createElement(
        U,
    ...
    class z extends s.Component {
        ...
        if (
          ...
          if (
            ((e = VRHTML.VRProperties.GetBoolProperty(
              n,
              u.z.DeviceProvidesBatteryStatus_Bool
            )),
            e)
          ) {
            const e = VRHTML.VRProperties.GetFloatProperty(
              n,
              u.z.DeviceBatteryPercentage_Float
            );
            (t = VRHTML.VRProperties.GetBoolProperty(
              n,
              u.z.DeviceIsCharging_Bool
            )),
      ...
      onDeviceEvent(e, t, n) {
        (e != u.m.Activated && e != u.m.Deactivated) || this.update();
      }
      render() {
        return s.createElement(
          "div",
    ...
    (z.kBatteryLevelHysteresis = 0.02),
      Object(a.b)([l.bind], z.prototype, "updateControllerStatus", null),
      Object(a.b)([l.bind], z.prototype, "onBatteryStateChanged", null),
      Object(a.b)([l.bind], z.prototype, "onDeviceRoleChanged", null),
      Object(a.b)([l.bind], z.prototype, "onDeviceEvent", null);
    s.Component;
    const q = (e) =>
      s.createElement(
        "div",
        { className: "Title" },
        s.createElement(j, { src: e.iconUrl, shadow: !0 }),
    ...
    Object(a.b)([l.bind], K.prototype, "onResizeObserved", null),
      Object(a.b)([l.bind], K.prototype, "updateBackgroundSize", null),
      Object(a.b)([l.bind], K.prototype, "onPortalDidMount", null);
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(Q, {
              ...
              interactionEndSoundEffect: p.a.VolumePreview,
            })
          ),
          ...
          s.createElement(
            ...
            s.createElement(Q, {
              ...
              renderValue: (e) => Math.round(100 * e) + "%",
              valueStyleVariant: S.c.OnHandle,
              additionalClassName: Object(h.a)(["Muted", y.a.Instance.muted]),
              interactionEndSoundEffect: p.a.VolumePreview,
            })
          )
        );
    ...
    Object(a.b)([l.bind], X.prototype, "onSliderMouseEnter", null),
      Object(a.b)([l.bind], X.prototype, "onSliderMouseLeave", null),
      Object(a.b)([l.bind], X.prototype, "onSliderFinalChange", null),
      Object(a.b)([b.f], X.prototype, "showAudioMirrorControls", null),
      Object(a.b)([b.f], X.prototype, "enableAudioMirrorControls", null),
      (X = Object(a.b)([_.a], X));
    ...
    Object(a.b)([l.bind], Q.prototype, "onMouseEnter", null),
      Object(a.b)([l.bind], Q.prototype, "onMouseLeave", null),
      Object(a.b)([l.bind], Q.prototype, "onInteractionStart", null),
      Object(a.b)([l.bind], Q.prototype, "onInteractionEnd", null),
      (Q = Object(a.b)([_.a], Q));
    ...
    Object(a.b)([l.bind], Y.prototype, "onMouseEnter", null),
      Object(a.b)([l.bind], Y.prototype, "onMouseLeave", null),
      (Y = Object(a.b)([_.a], Y));
    let J = (r = class extends s.Component {
      constructor() {
      ...
      onWindowMouseMove(e) {
        ...
        Object(u.O)(Object(u.kb)(t, this.m_vecOriginalMousePosition)) >
    ...
    (J.MIN_DRAG_THRESHOLD = 35),
      Object(a.b)([l.bind], J.prototype, "onButtonMouseDown", null),
      Object(a.b)([l.bind], J.prototype, "onWindowMouseMove", null),
      Object(a.b)([l.bind], J.prototype, "onWindowMouseUp", null),
      (J = r = Object(a.b)([_.a], J));
    const Z = (e) => {
      const t = s.useRef();
      return s.createElement(
        d.a,
              ...
              "steamvr_input" ==
                (null ===
                  (o =
                    null === (n = s.a) || void 0 === n
                      ? void 0
                      : n.SelectedAppActions) || void 0 === o
                  ? void 0
                  : o.category)) &&
            null != this.props.fnOpenOptionsModal,
          p = "PageTitleLabel";
        return (
          this.props.strSubTitle || (p += " SingleTitle"),
          i.createElement(
            "div",
            {
              className:
                "PageTitleBar" + (l.a.IsSteamAvailable ? "" : " NoSteam"),
            },
            i.createElement(
              "div",
              ...
              i.createElement(
                ...
                i.createElement("div", { className: p }, this.props.strTitle),
              ...
              d &&
                i.createElement(
                  ...
                  i.createElement(
                    c.a,
                    {
                      content: Object(a.c)("#BindingUI_OptionsButton_tooltip"),
                      theme: "MainButton",
                    },
                    i.createElement(
                      "div",
                      ...
                      Object(a.c)("#BindingUI_OptionsButton")
                    )
                  )
                )
            ),
            !l.a.IsSteamAvailable &&
              i.createElement(
                "div",
  ...
  vvDA: function (e, t, n) {
    ...
    class l extends r.Component {
      ...
      UpdateControllerStatus() {
        var e;
        if (!s.pb) return;
        const t = s.pb.VRProperties.GetBoolProperty(
            this.props.trackedDeviceIndex,
            s.z.DeviceProvidesBatteryStatus_Bool
          ),
          n = s.pb.VRSystem.GetControllerRoleForTrackedDeviceIndex(
            this.props.trackedDeviceIndex
          );
        let i = !1;
        if (t) {
          const t =
            null !=
            (e = s.pb.VRProperties.GetFloatProperty(
              this.props.trackedDeviceIndex,
              s.z.DeviceBatteryPercentage_Float
            ))
              ? e
              : 0;
          (i = s.pb.VRProperties.GetBoolProperty(
            this.props.trackedDeviceIndex,
            s.z.DeviceIsCharging_Bool
          )),
            null == this.batteryLevelStable || 0 == this.batteryLevelStable
      ...
      GetRoleIcon(e) {
        switch (e) {
          case s.x.TrackedControllerRole_RightHand:
            return "images/icons/controller_model_right.png";
          case s.x.TrackedControllerRole_LeftHand:
...
//# sourceMappingURL=controllerbindingui.js.map?v=db60a540cc5f3bc41f73
