      ...
      7677: (e, t, n) => {
        ...
        let de = (ie = class extends c.Component {
          ...
          renderDashboard() {
            ...
            let D = 2,
              B = 2.5;
            const P = b.G3.settings.get("/settings/dashboard/theaterPosition");
            P == re.Near
              ? ((D *= 0.5), (B *= 0.5))
              : P == re.Middle
              ? ((D *= 1), (B *= 1))
      ...
      7679: (e, t, n) => {
        ...
        const N = (e) =>
          d.createElement(
            P,
            { style: e.style },
            d.createElement(x, Object.assign({}, e))
          );
...
//# sourceMappingURL=controllerbindingui.js.map?v=7b757f7e7e9538fc83a5
