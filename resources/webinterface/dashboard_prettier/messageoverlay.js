 ...
 */ !(function (e) {
  ...
  "/i/y": function (e, t, r) {
          ...
          switch (t.nodeName.toUpperCase()) {
            ...
            case "VSG-MANIPULATION-TRANSFORM":
              (i = P("manipulation-transform", t)),
                (i.properties["is-moving"] = T(t, "is-moving")),
                (i.properties["parent-path"] = E(t, "parent-path")),
                (i.properties.translation = M(t, "translation")),
                (i.properties.rotation = M(t, "rotation")),
                (i.properties.scale = M(t, "scale"));
    ...
    var Ie, Pe, xe, Ve, Le, Be, Ne, Ae, He, Fe, je, Ue, We, ze, Ge, Ke, qe, Qe;
    !(function (e) {
      (e[(e.None = 0)] = "None"),
        (e[(e.Shown = 1)] = "Shown"),
        (e[(e.Hidden = 2)] = "Hidden"),
    ...
    let se = (X = class extends c.Component {
      ...
      renderDashboard() {
        ...
        if (k) {
          ...
          (C = !!e && VRHTML.VROverlay.GetFlag(e, s.E.EnableControlBar)),
            (O =
        ...
        let D = 2,
          M = 2.5;
        const w = p.d.settings.get("/settings/dashboard/theaterPosition");
        w == Y.Near
          ? ((D *= 1), (M *= 1))
          : w == Y.Middle
          ? ((D *= 4), (M *= 2.5))
        ...
        return (
          ...
          c.createElement(
            ...
            c.createElement(s.ob, { id: E, translation: { z: f } }),
            c.createElement(
              s.ob,
              {
                translation: {
  ...
  RCfx: function (e, t, r) {
    ...
    let _ = class extends l.Component {
      ...
      OnRenderMessageOverlay(e) {
        ...
        console.log(
          ...
          null === (t = h.pb) || void 0 === t || t.VROverlay.ShowDashboard(g.B);
      }
      ButtonClicked(e) {
        var t;
        if (!h.pb)
            ...
            l.createElement(
              ...
              this.state.sButtonTexts[0] &&
                l.createElement(v, {
                  ...
                  onClick: () => {
                    this.ButtonClicked(h.D.ButtonPress_0);
                  },
                }),
              this.state.sButtonTexts[1] &&
                l.createElement(v, {
                  ...
                  onClick: () => {
                    this.ButtonClicked(h.D.ButtonPress_1);
                  },
                }),
              this.state.sButtonTexts[2] &&
                l.createElement(v, {
                  ...
                  onClick: () => {
                    this.ButtonClicked(h.D.ButtonPress_2);
                  },
                }),
              this.state.sButtonTexts[3] &&
                l.createElement(v, {
                  ...
                  onClick: () => {
                    this.ButtonClicked(h.D.ButtonPress_3);
                  },
                })
            )
          )
    ...
    Object(a.b)([u.bind], _.prototype, "OnProcessQuit", null),
      ...
      null === (n = h.pb) ||
        void 0 === n ||
        n.VROverlay.SetWidthInMeters(h.pb.VROverlay.ThisOverlayHandle(), 1.92),
      null === (i = h.pb) ||
        void 0 === i ||
        i.VROverlay.SetFlag(
          h.pb.VROverlay.ThisOverlayHandle(),
          h.E.NoDashboardTab,
          !0
        ),
      null === (o = h.pb) ||
      ...
      Object(p.b)(
        [],
        null === (s = h.pb) || void 0 === s ? void 0 : s.GetSteamVRLanguage()
      )
        .then(() => {
      ...
      I = (e) => {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(p.cb, { id: T, location: p.t.BottomCenter })
          ),
          a.createElement(
            p.ob,
            { translation: { z: 1e-5 } },
...
//# sourceMappingURL=messageoverlay.js.map?v=2c69bc3af53465b4d05c
