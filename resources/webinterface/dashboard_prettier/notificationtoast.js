 ...
 */ !(function (e) {
  ...
  CPNy: function (e, t, r) {
    ...
    class u extends o.Component {
      ...
      OnRenderToast(e) {
        let t = l.pb.VROverlayInternal.GetToastInfo(e.notification_id);
        this.setState({
          title: t.sTitle,
          header: t.sHeader || "",
          text: t.sText,
    ...
    Object(i.b)([a.bind], u.prototype, "OnRenderToast", null),
      Object(c.b)(
        [],
        null === (n = l.pb) || void 0 === n ? void 0 : n.GetSteamVRLanguage()
      )
        .then(() => {
          s.render(o.createElement(u, null), document.getElementById("root"));
        })
        .catch((e) =>
    ...
    let se = (X = class extends c.Component {
      ...
      renderDashboard() {
        ...
        if (C) {
          ...
          (k = !!e && VRHTML.VROverlay.GetFlag(e, s.E.EnableControlBar)),
            (O =
              !this.state.mapOverlayState.has(C) ||
              this.state.mapOverlayState.get(C).dockLocation == b.i.Dashboard),
            (S =
              this.state.mapOverlayState.has(C) &&
              this.state.mapOverlayState.get(C).dockLocation == b.i.World);
        }
        ...
        let I,
          ...
          A = this.state.bTheaterMode
            ...
            : { x: 1, y: 1, z: 1 },
          H = !E && this.state.bTheaterMode ? 0.75 : 1,
          F = E ? 1 : 0;
        return (
          this.state.bTheaterMode
            ? ((I = { y: -0.8 * M + R, z: -D }),
          ...
          c.createElement(
            ...
            c.createElement(
                      ...
                      c.createElement(
                        ...
                        c.createElement(
                          d.a,
                          {
                            ...
                            onClick: () => {
                              this.onDockOverlay(C, b.i.Dashboard);
                            },
                          },
                          Object(h.c)("#DockHere")
                        )
              ...
              k && O && this.renderOverlayControlBar(),
              c.createElement(
                s.ob,
...
//# sourceMappingURL=notificationtoast.js.map?v=559322b3262de16c1971
