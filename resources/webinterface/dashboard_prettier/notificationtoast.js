 ...
 */ !(function (e) {
  ...
  "/i/y": function (e, t, r) {
          ...
          switch (t.nodeName.toUpperCase()) {
            case "VSG-TRANSFORM":
              (i = P("transform", t)),
                ...
                (i.properties["curvature-pitch"] = w(t, "curvature-pitch")),
            ...
            case "VSG-ELASTIC-HEAD-TRANSFORM":
              (i = P("elasticheadtransform", t)),
                (i.properties["start-angle-threshold"] = w(
                  t,
                  "start-angle-threshold"
                )),
                (i.properties["stop-angle-threshold"] = w(
                  t,
                  "stop-angle-threshold"
                )),
                (i.properties["ease-in-time"] = w(t, "ease-in-time")),
                (i.properties["ease-in-power"] = w(t, "ease-in-power")),
                (i.properties["ease-out-angle-threshold"] = w(
                  t,
                  "ease-out-angle-threshold"
                )),
                (i.properties["ease-out-power"] = w(t, "ease-out-power")),
                (i.properties["min-angular-velocity"] = w(
                  t,
                  "min-angular-velocity"
                )),
                (i.properties["max-angular-velocity"] = w(
                  t,
            ...
            case "VSG-LINE":
              (i = P("line", t)),
                ...
                (i.properties.thickness = w(t, "thickness")),
                (i.properties["start-buffer"] = w(t, "start-buffer")),
                (i.properties["end-buffer"] = w(t, "end-buffer"));
              break;
            case "VSG-LINE-CONSTRAINED-TRANSFORM":
              (i = P("line-constrained-transform", t)),
                (i.properties["target-id"] = I(t, "target-id")),
                (i.properties["source-id"] = I(t, "source-id")),
                (i.properties["source-distance"] = w(t, "source-distance")),
                (i.properties["target-limit"] = w(t, "target-limit"));
              break;
            ...
            case "VSG-PIN-TO-VIEW-TRANSFORM":
              (i = P("pin-to-view-transform", t)),
                (i.properties["offscreen-z-depth"] = w(t, "offscreen-z-depth")),
                (i.properties["off-axis-limit"] = w(t, "off-axis-limit")),
                (i.properties["transition-limit"] = w(t, "transition-limit"));
          }
          return [n, i];
        })(e, t),
        i = [];
    ...
    var oe, ae, se, le, ce, de, ue, he, pe, me, be;
    ...
    var Te, Ie, Pe, xe, Ve, Le, Be, Ne, Ae, He, Fe, je, Ue, We, ze, Ge, Ke, qe;
    !(function (e) {
      (e[(e.None = 0)] = "None"),
        (e[(e.Shown = 1)] = "Shown"),
        (e[(e.Hidden = 2)] = "Hidden"),
  ...
  CPNy: function (e, t, r) {
    "use strict";
    r.r(t),
      r.d(t, "NotificationToastMain", function () {
        return u;
      });
    var n,
      i = r("mrSG"),
    ...
    class u extends o.Component {
      ...
      OnRenderToast(e) {
        let t = l.ob.VROverlayInternal.GetToastInfo(e.notification_id);
        this.setState({
          title: t.sTitle,
          header: t.sHeader || "",
          text: t.sText,
    ...
    Object(i.b)([s.bind], u.prototype, "OnRenderToast", null),
      Object(c.b)(
        [],
        null === (n = l.ob) || void 0 === n ? void 0 : n.GetSteamVRLanguage()
      )
        .then(() => {
  ...
  Gmup: function (e, t, r) {
    ...
    (y.k_sMailboxName = "systemui_desktopview"),
      ...
      Object(o.b)([g.f], y.prototype, "desktopCount", null),
      Object(o.b)([g.f], y.prototype, "sCurrentOverlayKey", null),
      Object(o.b)([g.f], y.prototype, "currentDesktopIndex", null),
      Object(o.b)([g.f], y.prototype, "currentWindowHwnd", null),
    ...
    Object(o.b)([l.a], M.prototype, "buttonMouseEnter", null),
      Object(o.b)([l.a], M.prototype, "buttonMouseLeave", null),
      Object(o.b)([l.a], M.prototype, "onParentScrollStop", null),
      (M = Object(o.b)([m.a], M));
    const w = () =>
    ...
    let ae = (X = class extends c.Component {
      ...
      componentDidMount() {
        ...
        const r =
          ...
          n =
            r == a.G.AppLaunch_Unknown ||
            r == a.G.AppLaunch_Steam ||
            r == a.G.Unknown,
          i = p.d.settings.get(
      ...
      getCollisionBoundsFadeVisualizationElements() {
        ...
        for (let e of r) {
          let t = Object(a.Y)(Object(a.kb)(e[3], e[0])),
            r = Object(a.Y)(Object(a.kb)(e[1], e[0])),
            o = Object(a.h)(t, r),
            s = Object(a.T)(Object(a.b)(t, r, o)),
      ...
      renderControlBar(e, t) {
        ...
        const A = null != (l = p.d.settings.get(u.d)) && l,
          ...
          j =
            null !=
              (g = p.d.settings.get("/settings/dashboard/allowTheaterMode")) &&
            g;
        let U = { y: -0.25, z: 0 };
        return (
      ...
      renderDashboard() {
        ...
        if (M) {
          ...
          (D = !!e && VRHTML.VROverlay.GetFlag(e, a.E.EnableControlBar)),
            (k =
        ...
        const w =
          ...
          T =
            null ==
              (o = p.d.settings.get("/settings/dashboard/allowCurvature")) || o,
          I = T ? u.j : null;
        let P,
          x,
          V,
        ...
        return (
          ...
          c.createElement(
            ...
            c.createElement(a.nb, { id: I, translation: { z: O } }),
            c.createElement(
              a.nb,
              {
                translation: {
              ...
              c.createElement(
                a.nb,
                { translation: A, scale: H },
                c.createElement(
                  a.nb,
                  { rotation: { x: -35 }, curvature_pitch: -35 },
                  this.renderControlBar(g, v)
                ),
    ...
    (ae.k_sDashboardMailboxName = "systemui_dashboard"),
      ...
      Object(o.b)([g.f], ae.prototype, "isDarkMode", null),
      Object(o.b)([g.f], ae.prototype, "screenshotMode", null),
      Object(o.b)([g.f], ae.prototype, "isTheaterMode", null),
      Object(o.b)(
        [s.bind],
        ae.prototype,
      ...
      Object(o.b)([g.f], ae.prototype, "activeOverlayScale", null),
      Object(o.b)([s.bind], ae.prototype, "onActiveOverlayScaleChange", null),
      Object(o.b)([s.bind], ae.prototype, "onActiveOverlayClosed", null),
      Object(o.b)([g.m], ae, "s_dashboardUserDistance", void 0),
      Object(o.b)([g.m], ae, "s_dashboardUserScale", void 0),
  ...
  V1oe: function (e, t, r) {
    ...
    Object(i.b)([a.bind], v.prototype, "ComponentUpdated", null),
      Object(i.b)([a.bind], v.prototype, "UpdateSVGPath", null);
    class _ extends v {
      constructor(e) {
        super(e);
      }
  ...
  YRJX: function (e, t, r) {
      ...
      I = (e) => {
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(p.bb, { id: R, location: p.t.TopCenter }),
            s.createElement(
              k.a,
              { ref: i },
              s.createElement("div", {
            ...
            s.createElement(p.bb, { id: E, location: p.t.BottomCenter })
          ),
          s.createElement(
            p.nb,
            { translation: { z: 1e-5 } },
    ...
    let V = (n = class extends s.Component {
      constructor(e) {
        super(e),
          (this.state = {
      ...
      endMove() {
        ...
        this.setState({ xfTransform: a, sParent: x(this.state.destination) }),
          (this.m_bIsMoving = !1),
    ...
    (A.s_CurrentlyShownTooltip = null),
      Object(a.b)([b.f], A.prototype, "isShowingTooltip", null),
      Object(a.b)([b.d.bound], A.prototype, "show", null),
      Object(a.b)([b.d.bound], A.prototype, "hide", null),
      Object(a.b)([b.m], A, "s_CurrentlyShownTooltip", void 0),
      (A = i = Object(a.b)([v.a], A));
    class H extends s.Component {
      static ShouldInvertThumbnail(e) {
        ...
        if (((e = e.toLowerCase()), !H.s_mapShouldInvertThumbnail.has(e))) {
          ...
          e.endsWith(".svg") && (t = !0),
            e.startsWith("data:") &&
              H.k_rsThumbnailHashesToInvert.indexOf(M.a.hash(e)) >= 0 &&
              (t = !0),
  ...
  "ru2+": function (e, t, r) {
    ...
    Object(n.b)([d.f], b.prototype, "trackerConfig", null),
      Object(n.b)([a.bind], b.prototype, "OnTrackerRoleChanged", null),
      Object(n.b)([a.bind], b.prototype, "OnControllerRoleChanged", null),
      Object(n.b)([a.bind], b.prototype, "BuzzTracker", null),
      Object(n.b)([d.f], b.prototype, "deviceInfo", null),
      (b = Object(n.b)([o.a], b));
...
//# sourceMappingURL=notificationtoast.js.map?v=da8c3c29cff486cda390
