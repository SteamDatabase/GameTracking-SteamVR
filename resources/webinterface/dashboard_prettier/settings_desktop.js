...
(() => {
        ...
        let V = (i = class extends a.Component {
          ...
          computeDestination() {
            ...
            switch (this.state.sParent) {
              case "/user/hand/left":
                r && n.push({ pose: r, location: O.RightHand });
                break;
              case "/user/hand/right":
                t && n.push({ pose: t, location: O.LeftHand });
                break;
              case "/user/head":
                t && n.push({ pose: t, location: O.LeftHand }),
                  r && n.push({ pose: r, location: O.RightHand });
  ...
  (i.m = t),
    ...
    (i.nc = void 0);
  var n = i.O(void 0, [968, 683], () => i(2839));
  n = i.O(n);
})();
//# sourceMappingURL=settings_desktop.js.map?v=a482c381b52cc1d30c8d
